...
namespace undercarriage
{
    ...
    void Controller::PivotTurn()
    {
        ...
        // u_w = pid->rot_vel->Update(ref_vel.th - cur_vel.th) + (Tp1_w * ref_acc.th + ref_vel.th) / Kp_w;
        InputVelocity(u_v, u_w);
        // if (ENABLE_LOG)
        //     Logger();
    ...
    Direction Controller::getWallData()
    {
        ...
        if (ir_wall_value.fl3 > ir_param->is_wall.fl3 || ir_wall_value.fr3 > ir_param->is_wall.fr3)
        {
